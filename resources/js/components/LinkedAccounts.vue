<template>
    <div class="w-full bg-white rounded-lg py-6 px-6 shadow-lg flex flex-wrap antialiased">
        <div class="w-full flex flex-wrap border-b-2 border-gray-300 mb-4">
            <a href="#linked-accounts" class="text-white hover:text-gray-500 focus:text-green-500 focus:outline-none py-2 font-semibold leading-tight text-lg inline-flex justify-center items-center">
