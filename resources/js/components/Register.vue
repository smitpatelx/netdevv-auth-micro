      ...
      >
        <div class="w-full md:w-4/6 flex flex-wrap px-2">
            <div class="w-full flex flex-wrap justify-center pb-3">
                ...
                <p class="w-full text-center text-gray-800 font-normal text-xl mb-1 mx-2">Create your Netdevv Account</p>
                <a
            ...
            <div class="mt-6 pt-0 pb-4 flex flex-wrap">    
                ...
                <p class="ml-2 mt-1 w-full text-left text-gray-700 font-normal text-xs">
                    You can use letters, numbers &amp; periods
                </p>
                <div class="w-1/2 flex flex-wrap px-2 pt-2">
                    <label for="password" class="w-full text-xs my-1 text-left font-normal"
                ...
                <div class="w-1/2 flex flex-wrap px-2 pt-2">
                    <label for="confirm_password" class="w-full text-xs my-1 text-left font-normal"
        ...
        <div class="w-full md:w-2/6 hidden md:flex flex-wrap justify-center items-center content-center pl-2 pr-4">
            ...
            <h2 class="select-none w-full mt-2 text-black text-base font-normal">Access all services through single Netdevv account</h2>
        </div>
    </div>
    <!-- Help -->
